/**
 * VideoCall component representing the live video call interface.
 * Contains user video area, call controls, and a live chat panel.
 *
 * @component
 * @returns {JSX.Element} Video call interface UI
 */
